...
**Tests**: The examples below include test tasks. Tests are **MANDATORY** per Constitution Principle II (Testing Standards). Every user story MUST include unit and integration tests.
...
- [ ] TXXX [P] Additional unit tests (per Principle II) in tests/unit/
