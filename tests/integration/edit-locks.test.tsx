...
it('shows lock expiry guidance when editing locked resources', () => {
  render(<ReleaseForm weekId="w1" projectId="p1" selected={{ id: 'r1', week_id: 'w1', project_id: 'p1', version: 'v1', date: '2026-07-03', status: 'Approved', issue_count_a: 0, issue_count_b: 0, issue_count_c: 0, release_notes: '' }} onSaved={vi.fn()} />);
